...
export const createRutina_detallada = async (req, res) => {
    ...
    try{
        ...
        const result = await pool
            ...
            .query("INSERT INTO RUTINA_DETALLADA (series, repeticiones, peso, descanso, fecha_rutina, id_usuario, id_lista_ejercicio) VALUES (@series, @repeticiones, @peso, @descanso, @fecha_rutina, @id_usuario, @id_lista_ejercicio); SELECT SCOPE_IDENTITY() AS id;"
            );
...
//Actualizar un Rutina detallada 
export const updateRutina_detallada = async (req, res) => {
    ...
    const result = await pool.request()
        ...
        .input('id_lista_ejercicio', sql.Int, req.body.id_lista_ejercicio)
        .query(
            "UPDATE RUTINA_DETALLADA SET series = @series, repeticiones = @repeticiones, peso = @peso, descanso = @descanso, fecha_rutina = @fecha_rutina, id_usuario = @ id_usuario, id_lista_ejercicio = @id_lista_ejercicio   WHERE id_rutina_detallada = @id_rutina_detallada"
        );
